...
trait Assertions extends TripleEquals  {
   ...
   */
  def assert(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position): Assertion = new Assertion {} // macro AssertionsMacro.assert
   ...
   */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): Assertion = new Assertion {} // macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position): Assertion = new Assertion {} // macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): Assertion = new Assertion {} // macro AssertionsMacro.assumeWithClue
   ...
   */
  def assertTypeError(code: String)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.assertTypeErrorImpl
   ...
   * @param code the snippet of code that should not type check
   */
  def assertDoesNotCompile(code: String)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.assertDoesNotCompileImpl
   ...
   */
  def assertCompiles(code: String)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.assertCompilesImpl
