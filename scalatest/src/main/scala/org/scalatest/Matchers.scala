...
*/
  ...
  sealed class AnyShouldWrapper[T](val leftSideValue: T, val pos: source.Position, val prettifier: Prettifier) {
     ...
     * </pre>
     */
    def shouldBe(aType: ResultOfATypeInvocation[_]): Assertion = new Assertion {} // macro TypeMatcherMacro.shouldBeATypeImpl
     ...
     * </pre>
     */
    def shouldBe(anType: ResultOfAnTypeInvocation[_]): Assertion = new Assertion {} // macro TypeMatcherMacro.shouldBeAnTypeImpl
...
*/
  ...
  final class StringShouldWrapper(val leftSideString: String, pos: source.Position, prettifier: Prettifier) extends AnyShouldWrapper(leftSideString, pos, prettifier) with StringShouldWrapperForVerb {
     ...
     * </pre>
     */
    def should(compileWord: CompileWord)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.shouldCompileImpl
     ...
     * </pre>
     */
    def shouldNot(compileWord: CompileWord)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.shouldNotCompileImpl
     ...
     * </pre>
     */
    def shouldNot(typeCheckWord: TypeCheckWord)(implicit pos: source.Position): Assertion = new Assertion {} // macro CompileMacro.shouldNotTypeCheckImpl
