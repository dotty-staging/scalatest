...
object MatcherFactory$arity$ {
   ...
   */
  implicit def produceMatcher[SC: TypeTag, $typeConstructors$, T <: SC : $colonSeparatedTCNs$](matcherFactory: MatcherFactory$arity$[SC, $commaSeparatedTCNs$]): Matcher[T] =
    matcherFactory.matcher

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotATypeMatcherFactory$arity$[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#AndNotWord], aType: Expr[ResultOfATypeInvocation[_]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
   ...
   */
  def orNotATypeMatcherFactory$arity$[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#OrNotWord], aType: Expr[ResultOfATypeInvocation[_]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
    val rhs = TypeMatcherMacro.notATypeMatcher(aType)
    '{ (\$self).owner.or(\$rhs) }
  }
   ...
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory$arity$[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#AndNotWord], anType: Expr[ResultOfAnTypeInvocation[_]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
   ...
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory$arity$[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#OrNotWord], anType: Expr[ResultOfAnTypeInvocation[_]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
    val rhs = TypeMatcherMacro.notAnTypeMatcher(anType)
    '{ (\$self).owner.or(\$rhs) }
  }

  def andNotMatchPattern[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#AndNotWord], right: Expr[PartialFunction[Any, _]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
    val notMatcher = '{ MatchPatternHelper.notMatchPatternMatcher(\$right) }
    '{ (\$self).owner.and(\$notMatcher) }
  }

  def orNotMatchPattern[SC: TypeTag, $typeConstructors$](self: Expr[MatcherFactory$arity$[SC & AnyRef, $commaSeparatedTCNs$]#OrNotWord], right: Expr[PartialFunction[Any, _]])(implicit qctx: QuoteContext, $typeConstructorsWithType$): Expr[MatcherFactory$arity$[SC with AnyRef, $commaSeparatedTCNs$]] = {
    val notMatcher = '{ MatchPatternHelper.notMatchPatternMatcher(\$right) }
...
*/
  ...
  def genMatcherFactory(targetDir: File, arity: Int, scalaJS: Boolean): File = {
    ...
    def setCommonOnes(arity: Int, st: org.antlr.stringtemplate.StringTemplate) {
      ...
      val typeConstructorsWithType = (1 to arity).map(i => s"tp$i: TypeTag[TC$i]").mkString(", ")
