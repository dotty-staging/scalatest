    ...
    it("should produce difference of 2 Foos correctly") {
      ...
      assert(
        ObjectDiffer.difference(a, b, Prettifier.default).analysis ==
          (
            if (ScalacticVersions.BuiltForScalaVersion == "2.12" || ScalacticVersions.BuiltForScalaVersion == "2.13" || ScalacticVersions.BuiltForScalaVersion.startsWith("0.") || ScalacticVersions.BuiltForScalaVersion.startsWith("3."))
